...
public class Build implements BuilderInterface {
    ...
    protected int currentSmoothingGroupNumber = NO_SMOOTHING_GROUP;
    protected ArrayList<Face> currentSmoothingGroup = null;
    public HashMap<String, ArrayList<Face>> groups = new HashMap<String, ArrayList<Face>>();
    protected ArrayList<String> currentGroups = new ArrayList<String>();
    protected ArrayList<ArrayList<Face>> currentGroupFaceLists = new ArrayList<ArrayList<Face>>();
    public String objectName = null;
    protected Material currentMaterial = null;
    protected Material currentMap = null;
    public HashMap<String, Material> materialLib = new HashMap<String, Material>();
    protected Material currentMaterialBeingParsed = null;
    public HashMap<String, Material> mapLib = new HashMap<String, Material>();
    protected Material currentMapBeingParsed = null;
